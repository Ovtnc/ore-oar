  ...
  return (
    <section className="mx-auto w-full max-w-md px-4 py-14 md:px-8">
      <div className="rounded-2xl border border-[#D4AF37]/25 bg-zinc-900/60 p-6">
        ...
        <h1 className="mt-2 text-3xl font-semibold text-zinc-100">Giriş Yap</h1>
        <p className="mt-2 text-sm text-zinc-400">
          Sipariş verebilmek için hesabına giriş yap.
        </p>
        ...
        <p className="mt-4 text-sm text-zinc-400">
          Hesabın yok mu?{" "}
          <Link href={`/signup?next=${encodeURIComponent(nextPath)}`} className="text-[#D4AF37] hover:underline">
            Kayıt Ol
          </Link>
        </p>
      </div>
